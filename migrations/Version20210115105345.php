 ...
 */
final class Version20210115105345 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C13481D2B FOREIGN KEY (farmer_id) REFERENCES farmer (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
